...
Noticed your chair is making squeeky noise? Scratch your own itch by spraying it with WD-40.
Noticed people throwing rubbish here and there? Scratch your own itch by installing a trash can.
...
I figured that I needed an app that showed bright, colorful blinking lights on mobile screen. I didn't know programming full-fledged at the time, so I made use of the tool at hand: [MIT App Inventor](https://appinventor.mit.edu/)

It is a free, visual coding platform. Just in a few sittings, I had my android app ready. I named it Loom. You can download it from my [Google Drive folder here](https://drive.google.com/file/d/1tcBLCMcoYMAOrFYzqhureOe09I78K06X/view?usp=sharing). I still use that app. This is how it looks:

![Loom App Screenshot]({{ '/assets/images/uploads/loom-screenshot.webp' | relative_url }}){: width="300px" }
...
You have it.
I have it.
And we use this visa to travel far-away places digitally.
...
In [his X post](https://x.com/balajis/status/1998967507554832594), Balaji has addressed this point.

![Balaji on Internet]({{ '/assets/images/uploads/balaji-internet-international.webp' | relative_url }}){: width="800px" }
...
Several years back, I had read this statement somewhere on the social media: "your first dollar online changes your outlook."
...
It was this [Data System Design handbook](https://wuweied.gumroad.com/l/datasystem). I think somewhere around late 2022, I was feeling a strong urge to share my ideas on creating data system, from operational point of view. So, I typed out the mini-handbook and put up on Gumroad. Again, internet. It just lets you do things.

![Data System Design Handbook]({{ '/assets/images/uploads/data-system-design-gumroad.webp' | relative_url }}){: width="800px" }
...
![Open Source Comic]({{ '/assets/images/uploads/open-source_comic_xkcd.webp' | relative_url }}){: width="400px" }
...
Let me show you what I mean. A few weeks back, I was integrating a payment gateway provider named [Dodo Payments](https://dodopayments.com/) for my upcoming product Feedhammer. Some of their installation commands weren't working as expected. I checked, understood the mistakes in their documentation. Since their documentation is opensource, I suggested the fix in their Github repository. Wthin 5 days, they accepted the change and updated their documentation. A company where I would not qualify for their tech hiring, I could contribute in my small way. All developers depending on their documentation would save countless minutes. [Here's the source](https://github.com/dodopayments/dodo-docs/pull/215):

![Dodo Payments PR]({{ '/assets/images/uploads/dodopayments-pr.webp' | relative_url }}){: width="800px" }

Even if you're not a programmer, you can contribute to opensource projects. Google or ask your favourite AI tool about contributing to opensource projects as per your skills and interest. It will guide you. Or look into [this link](https://opensource.guide/how-to-contribute/) and [this link](https://www.firsttimersonly.com/).

So, what's the relevance of opensource with our discussion?
...
![Archimedes]({{ '/assets/images/uploads/archimedes-leverage.webp' | relative_url }}){: width="800px" }
...
Naval Ravikant has beautifully explained Leverage in [this interview](https://nav.al/rich). That webpage has mentioned "leverage" 132 times. Because there's a reason: leverage is everything for a man who just wants to do things.
...
I think about life in terms of a series of decisions. Choices if you like. And some philosophical tools make it easy to make decisions. One such tool is [Pascal's wager](https://en.wikipedia.org/wiki/Pascal%27s_wager).
...
![Pascal's Wager]({{ '/assets/images/uploads/pascals-wager-worthy-life.webp' | relative_url }}){: width="800px" }
